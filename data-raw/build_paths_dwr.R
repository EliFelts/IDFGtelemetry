...
deploy_locations.df <- read_excel(path = str_c(shared_parent.dir, "dwr_deployment_locations.xlsx", sep = "/"))
...
layer_name <- "dwr_paths_pts"
if (file.exists(out_gpkg)) file.remove(out_gpkg)

log_file <- "data-raw/dwr_path_log.csv"
...
dwr_network_points <- st_read("data-raw/all_paths.gpkg",
  layer = "dwr_paths_pts"
) |>
  mutate(
    rkm = dist_m / 1000,
...
use_data(dwr_network_points, overwrite = TRUE)
